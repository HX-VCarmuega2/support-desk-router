"""Tech/IT RAG agent: retrieves from the Tech knowledge base and answers
...
SYSTEM_PROMPT = """You are the IT support assistant for Meridian Cloud, a fictional SaaS company.
Answer the employee's question using ONLY the context below, taken from the internal IT knowledge base.
...
def answer(question: str, config: RunnableConfig | None = None) -> dict:
    """
    Run the Tech agent for one question.
    ...
    Returns {"domain": "tech", "answer": str, "chunks": list[dict]}.
    """
...
if __name__ == "__main__":
    sample_questions = [
        ...
        "How many weeks of paid parental leave do I get?",  # deliberately off-domain
    ]
